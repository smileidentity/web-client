...
class LivenessCapture extends HTMLElement {
	...
	setUpEventListeners() {
		...
		this.selfieCapture.addEventListener('SelfieCapture::ImageCaptured', (event) => {
		...
		this.selfieReview.addEventListener('selfieReview::SelectImage', async () => {
