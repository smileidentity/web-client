	...
	return `
		...
		<div class='flow'>
			...
			<div>
				...
				<p>
				Take your ID selfie image in a well-lit environment where it is easy to read, and free from glare on the card.
				</p>
			</div>
			</div>
			<div class='selfie-tips'>
			...
			<div>
				...
				<p>
				Ensure the photo of the ID selfie you submit is not blurry: you should be able to read the text on the selfie.
				</p>
			</div>
			</div>
		</div>
...
class SelfieInstruction extends HTMLElement {
	...
	get supportBothCaptureModes() {
		const value = this.selfieCaptureModes;
