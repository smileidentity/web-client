(() => {
  ...
  // src/js/components/ConsentScreen.js
  ...
  var TotpBasedConsent = class extends HTMLElement {
    constructor() {
      super();
  ...
  var TotpConsentApp_default = TotpBasedConsent;
  ...
  (function basicKyc() {
    ...
    window.customElements.define("end-user-consent", ConsentScreen_default);
    window.customElements.define("totp-consent-app", TotpConsentApp_default);
