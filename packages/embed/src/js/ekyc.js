...
(function eKYC() {
  ...
  async function completeOidcFlow(state) {
    ...
    // submission only carries `openid_state` so the KYC processor can read
    // them and skip the partner-typed ID form entirely.
  ...
  function handleOidcFlow() {
    ...
    if (disableBackOnFirstScreen) {
      OidcRedirect.querySelector('.back-wrapper').style.display = 'none';
    }
