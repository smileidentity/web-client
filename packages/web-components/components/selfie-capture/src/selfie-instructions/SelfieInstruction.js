  ...
  return `
    ...
    :host {
      ...
      * {
      ...
      #selfie-instruction-screen,
      #back-of-selfie-instruction-screen {
        block-size: 45rem;
        padding-block: 2rem;
        display: flex;
      ...
      #selfie-instruction-screen header p {
    ...
    ${styles}
    <div id="selfie-instruction-screen" class="flow center">
...
if ('customElements' in window && !window.customElements.get('selfie-instruction')) {
